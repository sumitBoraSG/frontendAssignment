...
const Navigation = () => {
    return (
        ...
        <div className="w-full flex flex-col items-center">
            <div className="w-[89.5%] flex justify-between relative border-b border-white pb-3 max-[568px]:h-[68px]">
                ...
                <div className="font-workSans font-normal flex items-center translate-y-2 gap-2.5 mt-[50px] text-sm text-white">
                    <a href="#" tabIndex={0} className="max-[500px]:hidden">WISHLIST (0)</a>
                    <a href="#" tabIndex={0} className="max-[500px]:hidden">BAG (0)</a>
                    <img tabIndex={0} className="min-[500px]:hidden" src={menuIcon} alt="menu button"/>
            ...
            <div className="w-[89.5%] flex">
                <div className="w-[55%] flex justify-between items-end max-[1090px]:w-[80%]">
                    ...
                    <div className="group relative">
                        ...
                        <ul className="absolute z-[999] hidden list-none pt-2 text-sm font-light font-workSans group-hover:block">
                            <li className="py-1">
                                <a href="#">PRODUCT 1</a>
                            </li>
                            <li className="py-1">
